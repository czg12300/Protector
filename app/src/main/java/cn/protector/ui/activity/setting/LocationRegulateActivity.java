 ...
 */
public class LocationRegulateActivity extends CommonTitleActivity implements View.OnClickListener, AMapLocationListener {
    ...
    public void onLocationChanged(AMapLocation aLocation) {
        if (mOnLocationChangedListener != null && aLocation != null) {
            ...
            mTvAddress.setText(aLocation.getCity() + aLocation.getAddress() + aLocation.getPoiName());
