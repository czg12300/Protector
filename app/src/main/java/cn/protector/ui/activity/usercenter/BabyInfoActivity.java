  ...
  private void showBirthdayDialog() {
    if (mBirthdayDialog == null) {
      ...
      mBirthdayDialog.findViewById(R.id.btn_ok).setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
          if (mDatePicker != null) {
            String birthday = String.format("%d年%02d月%02d日", mDatePicker.getYear(), mDatePicker.getMonth() + 1, mDatePicker.getDayOfMonth());
  ...
  private class ShoeSizeAdapter extends BaseListAdapter<String> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      if (convertView == null) {
        ...
        textView.setTextSize(TypedValue.COMPLEX_UNIT_PX, getDimension(R.dimen.text_content));
        AbsListView.LayoutParams params = new AbsListView.LayoutParams(MATCH_PARENT, DisplayUtil.dip(44));
